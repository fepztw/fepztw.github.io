...
(function(){angular.module("app.directive",["app.service","ngAnimate","ngSanitize","ui.bootstrap.selected","ga"]).directive("vuSticky",["WindowScroller"].concat(function(n){var e;return e="is-sticky",function(t,c,o){var r,i,u;return r=c.hasClass(e),i=+o.vuSticky,u=n.subscribe(function(n){var t;return t=n.scrollTop,t>i&&r!==!0?(r=!0,c.addClass(e)):i>t&&r!==!1?(r=!1,c.removeClass(e)):void 0}),t.$on("$destroy",u)}})).directive("vuSpy",["$window","Spy"].concat(function(n,e){return function(t,c,o){function r(){v=c[0].getBoundingClientRect(),p=n.innerHeight}function i(){t.$apply(function(){return e.current=e.spies.indexOf(l)}),s=!1}function u(){r(),!s&&v.top<=0&&v.bottom>0&&(n.requestAnimationFrame(i),s=!0)}function a(){angular.element(n).off("scroll",u)}var l,v,p,s;return l=t.$eval(o.vuSpy),e.add(l),v=p=null,s=!1,u(),angular.element(n).on("scroll",u),t.$on("$destory",function(){return e.remove(l),a()})}})).directive("noAnimate",["$animate"].concat(function(n){return function(e,t){return n.enabled(!1,t)}})).directive("vuCompile",["$compile"].concat(function(n){return{restrict:"EA",link:function(e,t,c){var o,r;return o=e.$eval(c.tmpl),r=n("<div>"+o+"</div>")(e),t.html("").append(r)}}})).directive("commentPopup",["TableData"].concat(function(n){return{restrict:"EA",replace:!0,scope:{content:"@",placement:"@",animation:"&",isOpen:"&"},templateUrl:"public/templates/comment-popup.html",link:function(e){return n.then(function(n){var t;return e.comments=function(){var c,o,r,i=[];for(c=0,r=(o=e.content.split(",")).length;r>c;++c)t=o[c],i.push(n.comments[t]);return i}()})}}})).directive("comment",["$tooltip"].concat(function(n){return n("comment","comment","click")})).directive("vuTrack",["ga","HtmlDecoder","DIMENSIONS","$timeout"].concat(function(n,e,t,c){return function(o,r,i){var u,a,l,v,p,s,m;u=o.$eval(i.vuTrack),null!=u.perspective&&(u.perspective=e(u.perspective)),null!=u.content&&(u.content=e(u.content)),l={hitType:"event",eventCategory:u.category||"button",eventLabel:u.label,eventValue:1},l[t.PERSPECTIVE+""]=u.perspective,l[t.POSITION+""]=u.position,a=l,null!=u.content&&(a.eventCategory="item",a.eventLabel=u.content),v=angular.extend({},a,{eventAction:"click"}),p=angular.extend({},a,{eventAction:"hover"}),r.on("click",function(){return n("send",v)}),s=null,m=null,r.on("mouseleave",function(){var e;return s&&c.cancel(s),e=Date.now()-m,n("send","timing",a.category,"hover",e),s=null,m=null}),r.on("mouseenter",function(){return m=Date.now(),s=c(function(){n("send",p),s=null},500)})}}))}).call(this);
