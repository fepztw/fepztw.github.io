...
(function(){angular.module("app.directive",["app.service","ngAnimate","ngSanitize","ui.bootstrap.selected"]).directive("vuSticky",["WindowScroller"].concat(function(n){var e;return e="is-sticky",function(t,i,r){var o,c,u;return o=i.hasClass(e),c=+r.vuSticky,u=n.subscribe(function(n){var t;return t=n.scrollTop,t>c&&o!==!0?(o=!0,i.addClass(e)):c>t&&o!==!1?(o=!1,i.removeClass(e)):void 0}),t.$on("$destroy",u)}})).directive("vuSpy",["$window","Spy"].concat(function(n,e){return function(t,i,r){function o(){s=i[0].getBoundingClientRect(),d=n.innerHeight}function c(){t.$apply(function(){return e.current=e.spies.indexOf(l)}),f=!1}function u(){o(),!f&&s.top<=0&&s.bottom>0&&(n.requestAnimationFrame(c),f=!0)}function a(){angular.element(n).off("scroll",u)}var l,s,d,f;return l=t.$eval(r.vuSpy),e.add(l),s=d=null,f=!1,u(),angular.element(n).on("scroll",u),t.$on("$destory",function(){return e.remove(l),a()})}})).directive("noAnimate",["$animate"].concat(function(n){return function(e,t){return n.enabled(!1,t)}}))}).call(this);
