...
(function(){var t,e,n,r=[].join;angular.module("app.service",["ngSanitize","ga"]).factory("WindowScroller",["$window","$timeout","$rootScope"].concat(function(t,e,n){var r,i,a,c,o,u;return r=angular.element(t),i={},a=function(){return i.offsetHeight=t.document.body.offsetHeight,i.clientHeight=t.document.body.clientHeight,i.scrollTop=t.document.body.scrollTop,i},c=[],o=!1,u=function(){var t;return n.$apply(function(){var t,e,n,r,a=[];for(t=0,n=(e=c).length;n>t;++t)r=e[t],a.push(r(i));return a}),t=!1},r.on("scroll",function(){var t;return a(),t?void 0:(requestAnimationFrame(u),t=!0)}),{subscribe:function(t){return c.push(t),e(function(){return t(a())}),function(){return c.splice(c.indexOf(t),1)}}}})).service("Spy",t=function(){function t(){this.spies=[],this.current=null}t.displayName="Spy";var e=t.prototype;return e.add=function(t){return this.spies=this.spies.concat(t)},e.remove=function(t){return this.spies.splice(this.spies.indexOf(t),1)},t}()).service("State",e=function(){function t(){function t(t,e){this[t]=e[0]}var e,r,i={}.hasOwnProperty;for(e in r=n["enum"])i.call(r,e)&&t.call(this,e,r[e])}t.displayName="State";var e=t.prototype,n=t;return t["enum"]={titlebar:["title","toolbox"],labels:[!0,!1]},e.$cycle=function(t){var e,r;return e=n["enum"][t].indexOf(this[t]),r=(e+1)%n["enum"][t].length,console.log(e,r),this[t]=n["enum"][t][r]},t}()).service("UserPreference",n=function(){function t(t){var n;e=t.localStorage,this.canSendData()&&(n=e.userId=e.userId||""+Math.random(),ga("set","dimension1",n))}t.displayName="UserPreference";var e,n=t.prototype;return e=null,t.$inject=["$window"],n.subscribe=function(t){e.email=t},n.getEmail=function(){return e.email},n.backout=function(){e.isBackedout=!0},n.canSendData=function(){return!e.isBackedout},t}()).factory("HtmlDecoder",function(){var t;return t=angular.element("<textarea></textarea>")[0],function(e){return t.innerHTML=e,t.value}}).factory("HighlightParser",["$interpolate"].concat(function(t){var e,n,i,a,c,o,u,s,l,p;return e='<{{tagName}} comment="{{id}}" comment-placement="top" comment-append-to-body="true">{{content}}</{{tagName}}>',n=/<span[^>]*>([^<]+)<\/span>((?:<sup>.+?<\/sup>)+)/gim,i=/#cmnt(\d+)/g,a="#cmnt".length,c=/<span[^>]*>/gim,o=/<\/span>/gim,u="xx-span-xx",s=new RegExp(u,"gm"),l=/\s+class="[^"]+"/gim,p=function(p){return p.replace(n,function(n,c,o){var s;return s=o.match(i).map(function(t){return t.slice(a)}),t(e)({id:r.call(s,","),content:c,tagName:u})}).replace(c,"").replace(o,"").replace(l,"").trim().replace(s,"span")},p.COMMENT_TEMPLATE=e,p})).factory("ItemSplitter",function(){var t,e,n;return t=/\[\s*&#20986;&#34389;\s*(?:&#160;)*/gm,e=/]/gim,n=/<span\s*[^>]*><\/span>/gim,function(r){var i;return i=r.search(t),-1===i&&(i=r.length),{content:r.slice(0,i),ref:r.slice(i).replace(t,"").replace(e,"").replace(n,"").trim()}}}).factory("TableParser",["ItemSplitter","HighlightParser","$sanitize"].concat(function(t,e,n){function r(t){return t.replace(o,"").trim()}function i(t){return t.replace(s,"").replace(l,"").trim()}var a,c,o,u,s,l;return a=/<tr[^>]*>(.+?)<\/tr>/gim,c=/<td[^>]*>(.*?)<\/td>/gim,o=/<\/?[^>]*>/gim,u=/<li[^>]*>(.+?)<\/li>/gim,s=/<li[^>]*>/,l=/<\/li>/,function(o){var s,l,p,m,f,h,g,d,v,y,S,b,E,T,N,O,x,R,$,H,I,P;for(s=o.replace(/\n/gm,"").match(a)||[""],l=(null!=(p=s[0].match(c))?p.slice(1):void 0)||[],f=[],h=0,g=l.length;g>h;++h)d=l[h],f.push(r(d));for(m=f,s.shift(),f=[],h=0,g=s.length;g>h;++h){for(y=s[h],l=y.match(c),S=r(l[0]),l.shift(),E=[],T=0,N=l.length;N>T;++T){for(d=l[T],O=d.match(u)||[],R=[],$=0,H=O.length;H>$;++$)I=O[$],P=t(i(I)),P.content=e(n(P.content)),P.ref=e(n(P.ref)),R.push(P);x=R,E.push(x)}b=E,f.push({title:S,positions:b})}return v=f,{positionTitle:m,perspectives:v}}})).factory("TableData",["TableParser","CommentParser","$http","DATA_URL","$q"].concat(function(t,e,n,r,i){var a;return a=i.defer(),n.get(r).success(function(n){var r;r=t(n),r.comments=e(n),a.resolve(r)}),a.promise})).factory("CommentParser",["linky"].concat(function(t){var e,n,r,i,a,c,o,u,s,l,p,m;return e="REF_MISSING",n="REF_CONTROVERSIAL",r="NOTE",i="SECOND",a="OTHER",c=/<div[^>]*><p[^>]*><a[^>]+name="cmnt(\d+)">[^>]+<\/a>(.+?)<\/div>/gim,o=/^\[([^\]]+)\]\s*/,u=/^\+1/,s=/<span class="[^"]+">/gim,l=/<\/span>/gim,p=/\s+class="[^"]+"/gim,m=function(m){function f(){switch(y){case"&#35036;&#20805;&#35498;&#26126;":return r;case"&#20358;&#28304;&#35531;&#27714;":return e;case"&#20358;&#28304;&#29229;&#35696;":return n;default:return a}}var h,g,d,v,y,S,b,E;for(h={};g=c.exec(m);)d=g[1],v=g[2].replace(s,"").replace(l,"").replace(p,"").trim(),y=null!=(S=v.match(o))?S[1]:void 0,b=f(),E=v.replace(o,"").trim(),E.match(u)&&(b=i),E=t("<p>"+E),h[d]={type:b,content:E};return h},m.types={REF_MISSING:e,REF_CONTROVERSIAL:n,NOTE:r,SECOND:i,OTHER:a},m})).factory("linky",function(){var t,e;return t=/((ftp|https?):\/\/|(mailto:)?[A-Za-z0-9._%+-]+@)[^\s<>]*[^\s.;,(){}<>]/,e=/^mailto:/,function(n,r){function i(t){return t?o.push(t):void 0}function a(t,e){return o.push("<a "),angular.isDefined(r)&&(o.push('target="'),o.push(r),o.push('" ')),o.push('href="'),o.push(t),o.push('">'),i(e),o.push("</a>")}var c,o,u,s,l;if(!n)return n;for(c=n,o=[];u=c.match(t);)s=u[0],u[2]===u[3]&&(s="mailto:"+s),l=u.index,i(c.substr(0,l)),a(s,u[0].replace(e,"")),c=c.substring(l+u[0].length);return i(c),o.join("")}})}).call(this);
...
(function(){angular.module("app.directive",["app.service","ngAnimate","ngSanitize","ui.bootstrap.selected","ga"]).directive("vuSticky",["WindowScroller"].concat(function(n){var e;return e="is-sticky",function(t,o,c){var i,r,u;return i=o.hasClass(e),r=+c.vuSticky,u=n.subscribe(function(n){var t;return t=n.scrollTop,t>r&&i!==!0?(i=!0,o.addClass(e)):r>t&&i!==!1?(i=!1,o.removeClass(e)):void 0}),t.$on("$destroy",u)}})).directive("vuSpy",["$window","Spy"].concat(function(n,e){return function(t,o,c){function i(){v=o[0].getBoundingClientRect(),p=n.innerHeight}function r(){t.$apply(function(){return e.current=e.spies.indexOf(l)}),s=!1}function u(){i(),!s&&v.top<=0&&v.bottom>0&&(n.requestAnimationFrame(r),s=!0)}function a(){angular.element(n).off("scroll",u)}var l,v,p,s;return l=t.$eval(c.vuSpy),e.add(l),v=p=null,s=!1,u(),angular.element(n).on("scroll",u),t.$on("$destory",function(){return e.remove(l),a()})}})).directive("noAnimate",["$animate"].concat(function(n){return function(e,t){return n.enabled(!1,t)}})).directive("vuCompile",["$compile"].concat(function(n){return{restrict:"EA",link:function(e,t,o){var c,i;return c=e.$eval(o.tmpl),i=n("<div>"+c+"</div>")(e),t.html("").append(i)}}})).directive("commentPopup",["TableData"].concat(function(n){return{restrict:"EA",replace:!0,scope:{content:"@",placement:"@",animation:"&",isOpen:"&"},templateUrl:"public/templates/comment-popup.html",link:function(e){return n.then(function(n){var t;return e.comments=function(){var o,c,i,r=[];for(o=0,i=(c=e.content.split(",")).length;i>o;++o)t=c[o],r.push(n.comments[t]);return r}()})}}})).directive("comment",["$tooltip"].concat(function(n){return n("comment","comment","click")})).directive("vuTrack",["ga","HtmlDecoder","DIMENSIONS","$timeout","$window"].concat(function(n,e,t,o,c){return function(i,r,u){var a,l,v,p,s,m,d,f;a=i.$eval(u.vuTrack),null!=a.perspective&&(a.perspective=e(a.perspective)),null!=a.content&&(a.content=e(a.content)),v={hitType:"event",eventCategory:a.category||"button",eventLabel:a.label,eventValue:1},v[t.PERSPECTIVE+""]=a.perspective,v[t.POSITION+""]=a.position,l=v,null!=a.content&&(l.eventCategory="item",l.eventLabel=a.content),p=angular.extend({},l,{eventAction:"click"}),s=angular.extend({},l,{eventAction:"hover"}),m=angular.extend({},l,{eventAction:"copy"}),r.on("click",function(){return n("send",p)}),d=null,f=null,r.on("mouseleave",function(){var e;return d&&o.cancel(d),e=Date.now()-f,n("send","timing",l.category,"hover",e),d=null,f=null}),r.on("mouseenter",function(){return f=Date.now(),d=o(function(){n("send",s),d=null},500)}),r.on("copy",function(){m[t.ITEM_CONTENT]=c.getSelection()+"",n("send",m)})}}))}).call(this);
