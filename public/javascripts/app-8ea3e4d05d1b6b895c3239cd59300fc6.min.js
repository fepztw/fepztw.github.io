...
(function(){var t,e,n,r=[].join;angular.module("app.service",["ngSanitize"]).factory("WindowScroller",["$window","$timeout","$rootScope"].concat(function(t,e,n){var r,i,c,a,o,s;return r=angular.element(t),i={},c=function(){return i.offsetHeight=t.document.body.offsetHeight,i.clientHeight=t.document.body.clientHeight,i.scrollTop=t.document.body.scrollTop,i},a=[],o=!1,s=function(){var t;return n.$apply(function(){var t,e,n,r,c=[];for(t=0,n=(e=a).length;n>t;++t)r=e[t],c.push(r(i));return c}),t=!1},r.on("scroll",function(){var t;return c(),t?void 0:(requestAnimationFrame(s),t=!0)}),{subscribe:function(t){return a.push(t),e(function(){return t(c())}),function(){return a.splice(a.indexOf(t),1)}}}})).service("Spy",t=function(){function t(){this.spies=[],this.current=null}t.displayName="Spy";var e=t.prototype;return e.add=function(t){return this.spies=this.spies.concat(t)},e.remove=function(t){return this.spies.splice(this.spies.indexOf(t),1)},t}()).service("State",e=function(){function t(){function t(t,e){this[t]=e[0]}var e,r,i={}.hasOwnProperty;for(e in r=n["enum"])i.call(r,e)&&t.call(this,e,r[e])}t.displayName="State";var e=t.prototype,n=t;return t["enum"]={titlebar:["title","toolbox"],labels:[!0,!1]},e.$cycle=function(t){var e,r;return e=n["enum"][t].indexOf(this[t]),r=(e+1)%n["enum"][t].length,console.log(e,r),this[t]=n["enum"][t][r]},t}()).service("UserPreference",n=function(){function t(t){e=t.localStorage}t.displayName="UserPreference";var e,n=t.prototype;return e=null,t.$inject=["$window"],n.subscribe=function(t){e.email=t},n.getEmail=function(){return e.email},n.backout=function(){e.isBackedout=!0},n.canSendData=function(){return!e.isBackedout},t}()).factory("HighlightParser",["$interpolate"].concat(function(t){var e,n,i,c,a,o,s,u,l,p;return e='<{{tagName}} comment="{{id}}" comment-placement="top" comment-append-to-body="true">{{content}}</{{tagName}}>',n=/<span class="[^"]+">([^<]+)<\/span>((?:<sup>.+?<\/sup>)+)/gim,i=/#cmnt(\d+)/g,c="#cmnt".length,a=/<span class="[^"]+">/gim,o=/<\/span>/gim,s="xx-span-xx",u=new RegExp(s,"gm"),l=/\s+class="[^"]+"/gim,p=function(p){return p.replace(n,function(n,a,o){var u;return u=o.match(i).map(function(t){return t.slice(c)}),t(e)({id:r.call(u,","),content:a,tagName:s})}).replace(a,"").replace(o,"").replace(l,"").trim().replace(u,"span")},p.COMMENT_TEMPLATE=e,p})).factory("ItemSplitter",function(){var t,e,n;return t=/\[\s*&#20986;&#34389;\s*(?:&#160;)*/gm,e=/]/gim,n=/<span\s*[^>]*><\/span>/gim,function(r){var i;return i=r.search(t),-1===i&&(i=r.length),{content:r.slice(0,i),ref:r.slice(i).replace(t,"").replace(e,"").replace(n,"").trim()}}}).factory("TableParser",["ItemSplitter","HighlightParser","$sanitize"].concat(function(t,e,n){function r(t){return t.replace(o,"").trim()}function i(t){return t.replace(u,"").replace(l,"").trim()}var c,a,o,s,u,l;return c=/<tr[^>]*>(.+?)<\/tr>/gim,a=/<td[^>]*>(.*?)<\/td>/gim,o=/<\/?[^>]*>/gim,s=/<li[^>]*>(.+?)<\/li>/gim,u=/<li[^>]*>/,l=/<\/li>/,function(o){var u,l,p,m,f,h,g,d,v,y,S,b,E,T,N,O,R,x,$,P,w,H;for(u=o.replace(/\n/gm,"").match(c)||[""],l=(null!=(p=u[0].match(a))?p.slice(1):void 0)||[],f=[],h=0,g=l.length;g>h;++h)d=l[h],f.push(r(d));for(m=f,u.shift(),f=[],h=0,g=u.length;g>h;++h){for(y=u[h],l=y.match(a),S=r(l[0]),l.shift(),E=[],T=0,N=l.length;N>T;++T){for(d=l[T],O=d.match(s)||[],x=[],$=0,P=O.length;P>$;++$)w=O[$],H=t(i(w)),H.content=e(n(H.content)),H.ref=e(n(H.ref)),x.push(H);R=x,E.push(R)}b=E,f.push({title:S,positions:b})}return v=f,{positionTitle:m,perspectives:v}}})).factory("TableData",["TableParser","CommentParser","$http","DATA_URL","$q"].concat(function(t,e,n,r,i){var c;return c=i.defer(),n.get(r).success(function(n){var r;r=t(n),r.comments=e(n),c.resolve(r)}),c.promise})).factory("CommentParser",["linky"].concat(function(t){var e,n,r,i,c,a,o,s,u,l,p,m;return e="REF_MISSING",n="REF_CONTROVERSIAL",r="NOTE",i="SECOND",c="OTHER",a=/<div[^>]*><p[^>]*><a[^>]+name="cmnt(\d+)">[^>]+<\/a>(.+?)<\/div>/gim,o=/^\[([^\]]+)\]\s*/,s=/^\+1/,u=/<span class="[^"]+">/gim,l=/<\/span>/gim,p=/\s+class="[^"]+"/gim,m=function(m){function f(){switch(y){case"&#35036;&#20805;&#35498;&#26126;":return r;case"&#20358;&#28304;&#35531;&#27714;":return e;case"&#20358;&#28304;&#29229;&#35696;":return n;default:return c}}var h,g,d,v,y,S,b,E;for(h={};g=a.exec(m);)d=g[1],v=g[2].replace(u,"").replace(l,"").replace(p,"").trim(),y=null!=(S=v.match(o))?S[1]:void 0,b=f(),E=v.replace(o,"").trim(),E.match(s)&&(b=i),E=t("<p>"+E),h[d]={type:b,content:E};return h},m.types={REF_MISSING:e,REF_CONTROVERSIAL:n,NOTE:r,SECOND:i,OTHER:c},m})).factory("linky",function(){var t,e;return t=/((ftp|https?):\/\/|(mailto:)?[A-Za-z0-9._%+-]+@)[^\s<>]*[^\s.;,(){}<>]/,e=/^mailto:/,function(n,r){function i(t){return t?o.push(t):void 0}function c(t,e){return o.push("<a "),angular.isDefined(r)&&(o.push('target="'),o.push(r),o.push('" ')),o.push('href="'),o.push(t),o.push('">'),i(e),o.push("</a>")}var a,o,s,u,l;if(!n)return n;for(a=n,o=[];s=a.match(t);)u=s[0],s[2]===s[3]&&(u="mailto:"+u),l=s.index,i(a.substr(0,l)),c(u,s[0].replace(e,"")),a=a.substring(l+s[0].length);return i(a),o.join("")}})}).call(this);
...
(function(){angular.module("app.directive",["app.service","ngAnimate","ngSanitize","ui.bootstrap.selected"]).directive("vuSticky",["WindowScroller"].concat(function(n){var t;return t="is-sticky",function(e,i,r){var c,o,u;return c=i.hasClass(t),o=+r.vuSticky,u=n.subscribe(function(n){var e;return e=n.scrollTop,e>o&&c!==!0?(c=!0,i.addClass(t)):o>e&&c!==!1?(c=!1,i.removeClass(t)):void 0}),e.$on("$destroy",u)}})).directive("vuSpy",["$window","Spy"].concat(function(n,t){return function(e,i,r){function c(){m=i[0].getBoundingClientRect(),p=n.innerHeight}function o(){e.$apply(function(){return t.current=t.spies.indexOf(l)}),s=!1}function u(){c(),!s&&m.top<=0&&m.bottom>0&&(n.requestAnimationFrame(o),s=!0)}function a(){angular.element(n).off("scroll",u)}var l,m,p,s;return l=e.$eval(r.vuSpy),t.add(l),m=p=null,s=!1,u(),angular.element(n).on("scroll",u),e.$on("$destory",function(){return t.remove(l),a()})}})).directive("noAnimate",["$animate"].concat(function(n){return function(t,e){return n.enabled(!1,e)}})).directive("vuCompile",["$compile"].concat(function(n){return{restrict:"EA",link:function(t,e,i){var r,c;return r=t.$eval(i.tmpl),c=n("<div>"+r+"</div>")(t),e.html("").append(c)}}})).directive("commentPopup",["TableData"].concat(function(n){return{restrict:"EA",replace:!0,scope:{content:"@",placement:"@",animation:"&",isOpen:"&"},templateUrl:"public/templates/comment-popup.html",link:function(t){return n.then(function(n){var e;return t.comments=function(){var i,r,c,o=[];for(i=0,c=(r=t.content.split(",")).length;c>i;++i)e=r[i],o.push(n.comments[e]);return o}()})}}})).directive("comment",["$tooltip"].concat(function(n){return n("comment","comment","click")}))}).call(this);
