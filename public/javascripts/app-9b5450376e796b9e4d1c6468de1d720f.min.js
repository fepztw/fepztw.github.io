...
(function(){angular.module("app.controller",["app.constant","app.service"]).controller("AppCtrl",["EDIT_URL","MockData","Spy","State"].concat(function(t,a,n,c){var o=this;this.EDIT_URL=t,a.then(function(t){return o.data=t}),this.Spy=n,this.State=c}))}).call(this);
angular.module("app.template",[]).run(["$templateCache",function(e){e.put("public/templates/empty.html",'目前沒有論述。<br><a ng-href="{{App.EDIT_URL}}">我來補充</a>！')}]);
(function(){angular.module("app.directive",["app.service"]).directive("vuSticky",["WindowScroller"].concat(function(n){var e;return e="is-sticky",function(t,o,r){var i,c,u;return i=o.hasClass(e),c=+r.vuSticky,u=n.subscribe(function(n){var t;return t=n.scrollTop,t>c&&i!==!0?(i=!0,o.addClass(e)):c>t&&i!==!1?(i=!1,o.removeClass(e)):void 0}),t.$on("$destroy",u)}})).directive("vuSpy",["$window","Spy"].concat(function(n,e){return function(t,o,r){function i(){s=o[0].getBoundingClientRect(),d=n.innerHeight}function c(){t.$apply(function(){return e.current=e.spies.indexOf(l)}),f=!1}function u(){i(),!f&&s.top<=0&&s.bottom>0&&(n.requestAnimationFrame(c),f=!0)}function a(){angular.element(n).off("scroll",u)}var l,s,d,f;return l=t.$eval(r.vuSpy),e.add(l),s=d=null,f=!1,u(),angular.element(n).on("scroll",u),t.$on("$destory",function(){return e.remove(l),a()})}})).directive("noAnimate",["$animate"].concat(function(n){return function(e,t){return console.log("no ng-animate on element",t),n.enabled(!1,t)}}))}).call(this);
(function(){angular.module("app",["app.controller","app.template","app.directive","angular.template","ngAnimate"])}).call(this);
