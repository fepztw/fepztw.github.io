...
(function(){function t(t){function e(){}return e.prototype=t,new e}var e,n,r,a,i=[].join;angular.module("app.service",["ngSanitize","ga","ui.bootstrap.selected"]).factory("WindowScroller",["$window","$timeout","$rootScope"].concat(function(t,e,n){var r,a,i,o,c,u;return r=angular.element(t),a={},i=function(){return a.offsetHeight=t.document.body.offsetHeight,a.clientHeight=t.document.body.clientHeight,a.scrollTop=t.document.body.scrollTop,a},o=[],c=!1,u=function(){var t;return n.$apply(function(){var t,e,n,r,i=[];for(t=0,n=(e=o).length;n>t;++t)r=e[t],i.push(r(a));return i}),t=!1},r.on("scroll",function(){var t;return i(),t?void 0:(requestAnimationFrame(u),t=!0)}),{subscribe:function(t){return o.push(t),e(function(){return t(i())}),function(){return o.splice(o.indexOf(t),1)}}}})).service("Spy",e=function(){function t(){this.spies=[],this.current=null}t.displayName="Spy";var e=t.prototype;return e.add=function(t){return this.spies=this.spies.concat(t)},e.remove=function(t){return this.spies.splice(this.spies.indexOf(t),1)},t}()).service("State",n=function(){function t(){function t(t,e){this[t]=e[0]}var e,r,a={}.hasOwnProperty;for(e in r=n["enum"])a.call(r,e)&&t.call(this,e,r[e])}t.displayName="State";var e=t.prototype,n=t;return t["enum"]={titlebar:["title","toolbox"],labels:[!0,!1],comment:[null]},e.$cycle=function(t){var e,r;return e=n["enum"][t].indexOf(this[t]),r=(e+1)%n["enum"][t].length,console.log(e,r),this[t]=n["enum"][t][r]},e.$reset=function(t){return this[t]=n["enum"][t][0]},e.$isDefault=function(t){return this[t]===n["enum"][t][0]},t}()).service("UserPreference",r=function(){function t(t){var n;e=t.localStorage,this.canSendData()&&(n=e.userId=e.userId||""+Math.random(),ga("set","dimension1",n))}t.displayName="UserPreference";var e,n=t.prototype;return e=null,t.$inject=["$window"],n.subscribe=function(t){e.email=t},n.getEmail=function(){return e.email},n.backout=function(){e.isBackedout=!0},n.canSendData=function(){return!e.isBackedout},t}()).factory("HtmlDecoder",function(){var t;return t=angular.element("<textarea></textarea>")[0],function(e){return t.innerHTML=e,t.value}}).factory("HighlightParser",["$interpolate"].concat(function(e){var n,r,a,o,c,u,l,s,p,m;return n=/<span[^>]*>([^<]+)<\/span>((?:<sup>.+?<\/sup>)+)/gim,r=/#cmnt(\d+)/g,a="#cmnt".length,o=/<span[^>]*>/gim,c=/<\/span>/gim,u="xx-span-xx",l=new RegExp(u,"gm"),s=/\s+class="[^"]+"/gim,p=function(n){return n=t(n),n.placement="{{placement}}",n.tagName||(n.tagName="span"),e('<{{tagName}} comment="{{id}}" comment-placement="{{placement}}" comment-append-to-body="true">{{content}}</{{tagName}}>')(n)},m=function(t){return t.replace(n,function(t,e,n){var o;return o=n.match(r).map(function(t){return t.slice(a)}),p({id:i.call(o,","),content:e,tagName:u})}).replace(o,"").replace(c,"").replace(s,"").trim().replace(l,"span")},m.GENERATE_COMMENT=p,m})).factory("ItemSplitter",function(){var t,e,n;return t=/\[\s*&#20986;&#34389;\s*(?:&#160;)*/gm,e=/]/gim,n=/<span\s*[^>]*><\/span>/gim,function(r){var a;return a=r.search(t),-1===a&&(a=r.length),{content:r.slice(0,a),ref:r.slice(a).replace(t,"").replace(e,"").replace(n,"").trim()}}}).factory("TableParser",["ItemSplitter","HighlightParser","$sanitize"].concat(function(t,e,n){function r(t){return t.replace(c,"").trim()}function a(t){return t.replace(l,"").replace(s,"").trim()}var i,o,c,u,l,s;return i=/<tr[^>]*>(.+?)<\/tr>/gim,o=/<td[^>]*>(.*?)<\/td>/gim,c=/<\/?[^>]*>/gim,u=/<li[^>]*>(.+?)<\/li>/gim,l=/<li[^>]*>/,s=/<\/li>/,function(c){var l,s,p,m,f,h,d,g,v,y,b,S,N,E,$,M,T,O,x,R,C,H;for(l=c.replace(/\n/gm,"").match(i)||[""],s=(null!=(p=l[0].match(o))?p.slice(1):void 0)||[],f=[],h=0,d=s.length;d>h;++h)g=s[h],f.push(r(g));for(m=f,l.shift(),f=[],h=0,d=l.length;d>h;++h){for(y=l[h],s=y.match(o),b=r(s[0]),s.shift(),N=[],E=0,$=s.length;$>E;++E){for(g=s[E],M=g.match(u)||[],O=[],x=0,R=M.length;R>x;++x)C=M[x],H=t(a(C)),H.content=e(n(H.content)),H.ref=e(n(H.ref)),O.push(H);T=O,N.push(T)}S=N,f.push({title:b,positions:S})}return v=f,{positionTitle:m,perspectives:v}}})).factory("TableData",["TableParser","CommentParser","$http","DATA_URL","$q"].concat(function(t,e,n,r,a){var i;return i=a.defer(),n.get(r).success(function(n){var r;r=t(n),r.comments=e(n),i.resolve(r)}),i.promise})).factory("CommentParser",["linky"].concat(function(t){var e,n,r,a,i,o,c,u,l,s,p,m;return e="REF_MISSING",n="REF_CONTROVERSIAL",r="NOTE",a="SECOND",i="OTHER",o=/<div[^>]*><p[^>]*><a[^>]+name="cmnt(\d+)">[^>]+<\/a>(.+?)<\/div>/gim,c=/^\[([^\]]+)\]\s*/,u=/^\+1/,l=/<span class="[^"]+">/gim,s=/<\/span>/gim,p=/\s+class="[^"]+"/gim,m=function(m){function f(){switch(y){case"&#35036;&#20805;&#35498;&#26126;":return r;case"&#38656;&#35201;&#20986;&#34389;":return e;case"&#20986;&#34389;&#29229;&#35696;":return n;default:return i}}var h,d,g,v,y,b,S,N;for(h={};d=o.exec(m);)g=d[1],v=d[2].replace(l,"").replace(s,"").replace(p,"").trim(),y=null!=(b=v.match(c))?b[1]:void 0,S=f(),N=v.replace(c,"").trim(),N.match(u)&&(S=a),N=t("<p>"+N),h[g]={type:S,content:N};return h},m.types={REF_MISSING:e,REF_CONTROVERSIAL:n,NOTE:r,SECOND:a,OTHER:i},m})).factory("linky",function(){var t,e;return t=/((ftp|https?):\/\/|(mailto:)?[A-Za-z0-9._%+-]+@)[^\s<>]*[^\s.;,(){}<>]/,e=/^mailto:/,function(n,r){function a(t){return t?c.push(t):void 0}function i(t,e){return c.push("<a "),angular.isDefined(r)&&(c.push('target="'),c.push(r),c.push('" ')),c.push('href="'),c.push(t),c.push('">'),a(e),c.push("</a>")}var o,c,u,l,s;if(!n)return n;for(o=n,c=[];u=o.match(t);)l=u[0],u[2]===u[3]&&(l="mailto:"+l),s=u.index,a(o.substr(0,s)),i(l,u[0].replace(e,"")),o=o.substring(s+u[0].length);return a(o),c.join("")}}).service("ModalManager",a=function(){function t(t){this.$modal=t}t.displayName="ModalManager";var e,n=t.prototype;return e={edit:{templateUrl:"public/templates/edit.html",controller:"ModalCtrl as Modal"},subscribe:{templateUrl:"public/templates/subscribe-modal.html",controller:"ModalCtrl as Modal",size:"sm"},info:{templateUrl:"public/templates/info.html",controller:"ModalCtrl as Modal"}},t.$inject=["$modal"],n.open=function(t){return this.$modal.open(e[t])},t}())}).call(this);
