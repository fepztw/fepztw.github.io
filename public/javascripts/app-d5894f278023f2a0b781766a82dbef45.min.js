...
angular.module("angular.template.modal",[]).run(["$templateCache",function(a){a.put("template/modal/backdrop.html",'<div class="modal-backdrop fade {{ backdropClass }}"\n     ng-class="{in: animate}"\n     ng-style="{\'z-index\': 1040 + (index && 1 || 0) + index*10}"\n></div>\n'),a.put("template/modal/window.html",'<div tabindex="-1" role="dialog" class="modal fade" ng-class="{in: animate}" ng-style="{\'z-index\': 1050 + index*10, display: \'block\'}" ng-click="close($event)">\n    <div class="modal-dialog" ng-class="{\'modal-sm\': size == \'sm\', \'modal-lg\': size == \'lg\'}"><div class="modal-content" modal-transclude></div></div>\n</div>')}]);
angular.module("angular.template.tooltip",[]).run(["$templateCache",function(t){t.put("template/tooltip/tooltip-html-unsafe-popup.html",'<div class="tooltip {{placement}}" ng-class="{ in: isOpen(), fade: animation() }">\n  <div class="tooltip-arrow"></div>\n  <div class="tooltip-inner" bind-html-unsafe="content"></div>\n</div>\n'),t.put("template/tooltip/tooltip-popup.html",'<div class="tooltip {{placement}}" ng-class="{ in: isOpen(), fade: animation() }">\n  <div class="tooltip-arrow"></div>\n  <div class="tooltip-inner" ng-bind="content"></div>\n</div>\n')}]);
angular.module("ui.bootstrap.transition",[]).factory("$transition",["$q","$timeout","$rootScope",function(n,i,t){function a(n){for(var i in n)if(void 0!==r.style[i])return n[i]}var o=function(a,r,e){e=e||{};var s=n.defer(),d=o[e.animation?"animationEndEventName":"transitionEndEventName"],u=function(){t.$apply(function(){a.unbind(d,u),s.resolve(a)})};return d&&a.bind(d,u),i(function(){angular.isString(r)?a.addClass(r):angular.isFunction(r)?r(a):angular.isObject(r)&&a.css(r),d||s.resolve(a)}),s.promise.cancel=function(){d&&a.unbind(d,u),s.reject("Transition cancelled")},s.promise},r=document.createElement("trans"),e={WebkitTransition:"webkitTransitionEnd",MozTransition:"transitionend",OTransition:"oTransitionEnd",transition:"transitionend"},s={WebkitTransition:"webkitAnimationEnd",MozTransition:"animationend",OTransition:"oAnimationEnd",transition:"animationend"};return o.transitionEndEventName=a(e),o.animationEndEventName=a(s),o}]);
angular.module("ui.bootstrap.modal",["ui.bootstrap.transition"]).factory("$$stackedMap",function(){return{createNew:function(){var e=[];return{add:function(n,t){e.push({key:n,value:t})},get:function(n){for(var t=0;t<e.length;t++)if(n==e[t].key)return e[t]},keys:function(){for(var n=[],t=0;t<e.length;t++)n.push(e[t].key);return n},top:function(){return e[e.length-1]},remove:function(n){for(var t=-1,o=0;o<e.length;o++)if(n==e[o].key){t=o;break}return e.splice(t,1)[0]},removeTop:function(){return e.splice(e.length-1,1)[0]},length:function(){return e.length}}}}}).directive("modalBackdrop",["$timeout",function(e){return{restrict:"EA",replace:!0,templateUrl:"template/modal/backdrop.html",link:function(n,t,o){n.backdropClass=o.backdropClass||"",n.animate=!1,e(function(){n.animate=!0})}}}]).directive("modalWindow",["$modalStack","$timeout",function(e,n){return{restrict:"EA",scope:{index:"@",animate:"="},replace:!0,transclude:!0,templateUrl:function(e,n){return n.templateUrl||"template/modal/window.html"},link:function(t,o,r){o.addClass(r.windowClass||""),t.size=r.size,n(function(){t.animate=!0,o[0].focus()}),t.close=function(n){var t=e.getTop();t&&t.value.backdrop&&"static"!=t.value.backdrop&&n.target===n.currentTarget&&(n.preventDefault(),n.stopPropagation(),e.dismiss(t.key,"backdrop click"))}}}}]).directive("modalTransclude",function(){return{link:function(e,n,t,o,r){r(e.$parent,function(e){n.empty(),n.append(e)})}}}).factory("$modalStack",["$transition","$timeout","$document","$window","$compile","$rootScope","$$stackedMap",function(e,n,t,o,r,a,i){function l(){y[0].clientWidth>=o.innerWidth||(w=w||c())}function c(){var e=angular.element('<div class="'+h+'"></div>');y.append(e);var n=e[0].offsetWidth-e[0].clientWidth;return console.log("measureScrollbar",n),e.remove(),n}function d(){if(w){var e=parseInt(y.css("padding-right")||0,10);console.log("setting scrollbar: ",e,w),y.css("padding-right",e+w+"px")}}function s(){y.css("padding-right","")}function u(){for(var e=-1,n=$.keys(),t=0;t<n.length;t++)$.get(n[t]).value.backdrop&&(e=t);return e}function p(e){var n=t.find("body").eq(0),o=$.get(e).value;$.remove(e),m(o.modalDomEl,o.modalScope,300,function(){o.modalScope.$destroy(),n.toggleClass(k,$.length()>0),0===$.length()&&s(),f()})}function f(){if(v&&-1==u()){var e=g;m(v,g,150,function(){e.$destroy(),e=null}),v=void 0,g=void 0}}function m(t,o,r,a){function i(){i.done||(i.done=!0,t.remove(),a&&a())}o.animate=!1;var l=e.transitionEndEventName;if(l){var c=n(i,r);t.bind(l,function(){n.cancel(c),i(),o.$apply()})}else n(i)}var v,g,k="modal-open",h="modal-scrollbar-measure",$=i.createNew(),b={},w=0,y=angular.element(t[0].body);return a.$watch(u,function(e){g&&(g.index=e)}),t.bind("keydown",function(e){var n;27===e.which&&(n=$.top(),n&&n.value.keyboard&&(e.preventDefault(),a.$apply(function(){b.dismiss(n.key,"escape key press")})))}),b.open=function(e,n){$.add(e,{deferred:n.deferred,modalScope:n.scope,backdrop:n.backdrop,keyboard:n.keyboard});var o=t.find("body").eq(0),i=u();if(i>=0&&!v){g=a.$new(!0),g.index=i;var c=angular.element("<div modal-backdrop></div>");c.attr("backdrop-class",n.backdropClass),v=r(c)(g),o.append(v),l()}var s=angular.element("<div modal-window></div>");s.attr({"template-url":n.windowTemplateUrl,"window-class":n.windowClass,size:n.size,index:$.length()-1,animate:"animate"}).html(n.content);var p=r(s)(n.scope);$.top().value.modalDomEl=p,o.append(p),o.addClass(k),d()},b.close=function(e,n){var t=$.get(e);t&&(t.value.deferred.resolve(n),p(e))},b.dismiss=function(e,n){var t=$.get(e);t&&(t.value.deferred.reject(n),p(e))},b.dismissAll=function(e){for(var n=this.getTop();n;)this.dismiss(n.key,e),n=this.getTop()},b.getTop=function(){return $.top()},b}]).provider("$modal",function(){var e={options:{backdrop:!0,keyboard:!0},$get:["$injector","$rootScope","$q","$http","$templateCache","$controller","$modalStack",function(n,t,o,r,a,i,l){function c(e){return e.template?o.when(e.template):r.get(angular.isFunction(e.templateUrl)?e.templateUrl():e.templateUrl,{cache:a}).then(function(e){return e.data})}function d(e){var t=[];return angular.forEach(e,function(e){(angular.isFunction(e)||angular.isArray(e))&&t.push(o.when(n.invoke(e)))}),t}var s={};return s.open=function(n){var r=o.defer(),a=o.defer(),s={result:r.promise,opened:a.promise,close:function(e){l.close(s,e)},dismiss:function(e){l.dismiss(s,e)}};if(n=angular.extend({},e.options,n),n.resolve=n.resolve||{},!n.template&&!n.templateUrl)throw new Error("One of template or templateUrl options is required.");var u=o.all([c(n)].concat(d(n.resolve)));return u.then(function(e){var o=(n.scope||t).$new();o.$close=s.close,o.$dismiss=s.dismiss;var a,c={},d=1;n.controller&&(c.$scope=o,c.$modalInstance=s,angular.forEach(n.resolve,function(n,t){c[t]=e[d++]}),a=i(n.controller,c),n.controller&&(o[n.controllerAs]=a)),l.open(s,{scope:o,deferred:r,content:e[0],backdrop:n.backdrop,keyboard:n.keyboard,backdropClass:n.backdropClass,windowClass:n.windowClass,windowTemplateUrl:n.windowTemplateUrl,size:n.size})},function(e){r.reject(e)}),u.then(function(){a.resolve(!0)},function(){a.reject(!1)}),s},s}]};return e});
angular.module("ui.bootstrap.position",[]).factory("$position",["$document","$window",function(t,e){function o(t,o){return t.currentStyle?t.currentStyle[o]:e.getComputedStyle?e.getComputedStyle(t)[o]:t.style[o]}function n(t){return"static"===(o(t,"position")||"static")}var f=function(e){for(var o=t[0],f=e.offsetParent||o;f&&f!==o&&n(f);)f=f.offsetParent;return f||o};return{position:function(e){var o=this.offset(e),n={top:0,left:0},r=f(e[0]);r!=t[0]&&(n=this.offset(angular.element(r)),n.top+=r.clientTop-r.scrollTop,n.left+=r.clientLeft-r.scrollLeft);var i=e[0].getBoundingClientRect();return{width:i.width||e.prop("offsetWidth"),height:i.height||e.prop("offsetHeight"),top:o.top-n.top,left:o.left-n.left}},offset:function(o){var n=o[0].getBoundingClientRect();return{width:n.width||o.prop("offsetWidth"),height:n.height||o.prop("offsetHeight"),top:n.top+(e.pageYOffset||t[0].documentElement.scrollTop),left:n.left+(e.pageXOffset||t[0].documentElement.scrollLeft)}},positionElements:function(t,e,o,n){var f,r,i,l,p=o.split("-"),u=p[0],s=p[1]||"center";f=n?this.offset(t):this.position(t),r=e.prop("offsetWidth"),i=e.prop("offsetHeight");var c={center:function(){return f.left+f.width/2-r/2},left:function(){return f.left},right:function(){return f.left+f.width}},h={center:function(){return f.top+f.height/2-i/2},top:function(){return f.top},bottom:function(){return f.top+f.height}};switch(u){case"right":l={top:h[s](),left:c[u]()};break;case"left":l={top:h[s](),left:f.left-r};break;case"bottom":l={top:h[u](),left:c[s]()};break;default:l={top:f.top-i,left:c[s]()}}return l}}}]);
angular.module("ui.bootstrap.bindHtml",[]).directive("bindHtmlUnsafe",function(){return function(n,i,t){i.addClass("ng-binding").data("$binding",t.bindHtmlUnsafe),n.$watch(t.bindHtmlUnsafe,function(n){i.html(n||"")})}});
angular.module("ui.bootstrap.tooltip",["ui.bootstrap.position","ui.bootstrap.bindHtml"]).provider("$tooltip",function(){function t(t){var n=/[A-Z]/g,e="-";return t.replace(n,function(t,n){return(n?e:"")+t.toLowerCase()})}var n={placement:"top",animation:!0,popupDelay:0},e={mouseenter:"mouseleave",click:"click",focus:"blur"},o={};this.options=function(t){angular.extend(o,t)},this.setTriggers=function(t){angular.extend(e,t)},this.$get=["$window","$compile","$timeout","$parse","$document","$position","$interpolate",function(i,p,a,l,u,r,c){return function(i,s,f){function d(t){var n=t||m.trigger||f,o=e[n]||n;return{show:n,hide:o}}var m=angular.extend({},n,o),v=t(i),$=c.startSymbol(),b=c.endSymbol(),g="<div "+v+'-popup title="'+$+"tt_title"+b+'" content="'+$+"tt_content"+b+'" placement="'+$+"tt_placement"+b+'" animation="tt_animation" is-open="tt_isOpen"></div>';return{restrict:"EA",scope:!0,compile:function(){var t=p(g);return function(n,e,o){function p(){n.tt_isOpen?f():c()}function c(){(!w||n.$eval(o[s+"Enable"]))&&(n.tt_popupDelay?y||(y=a(v,n.tt_popupDelay,!1),y.then(function(t){t()})):v()())}function f(){n.$apply(function(){$()})}function v(){return y=null,h&&(a.cancel(h),h=null),n.tt_content?(b(),_.css({top:0,left:0,display:"block"}),D?u.find("body").append(_):e.after(_),A(),n.tt_isOpen=!0,n.$digest(),A):angular.noop}function $(){n.tt_isOpen=!1,a.cancel(y),y=null,n.tt_animation?h||(h=a(g,500)):g()}function b(){_&&g(),_=t(n,function(){}),n.$digest()}function g(){h=null,_&&(_.remove(),_=null)}var _,h,y,D=angular.isDefined(m.appendToBody)?m.appendToBody:!1,O=d(void 0),w=angular.isDefined(o[s+"Enable"]),A=function(){var t=r.positionElements(e,_,n.tt_placement,D);t.top+="px",t.left+="px",_.css(t)};n.tt_isOpen=!1,o.$observe(i,function(t){n.tt_content=t,!t&&n.tt_isOpen&&$()}),o.$observe(s+"Title",function(t){n.tt_title=t}),o.$observe(s+"Placement",function(t){n.tt_placement=angular.isDefined(t)?t:m.placement}),o.$observe(s+"PopupDelay",function(t){var e=parseInt(t,10);n.tt_popupDelay=isNaN(e)?m.popupDelay:e});var E=function(){e.unbind(O.show,c),e.unbind(O.hide,f)};o.$observe(s+"Trigger",function(t){E(),O=d(t),O.show===O.hide?e.bind(O.show,p):(e.bind(O.show,c),e.bind(O.hide,f))});var T=n.$eval(o[s+"Animation"]);n.tt_animation=angular.isDefined(T)?!!T:m.animation,o.$observe(s+"AppendToBody",function(t){D=angular.isDefined(t)?l(t)(n):D}),D&&n.$on("$locationChangeSuccess",function(){n.tt_isOpen&&$()}),n.$on("$destroy",function(){a.cancel(h),a.cancel(y),E(),g()})}}}}}]}).directive("tooltipPopup",function(){return{restrict:"EA",replace:!0,scope:{content:"@",placement:"@",animation:"&",isOpen:"&"},templateUrl:"template/tooltip/tooltip-popup.html"}}).directive("tooltip",["$tooltip",function(t){return t("tooltip","tooltip","mouseenter")}]).directive("tooltipHtmlUnsafePopup",function(){return{restrict:"EA",replace:!0,scope:{content:"@",placement:"@",animation:"&",isOpen:"&"},templateUrl:"template/tooltip/tooltip-html-unsafe-popup.html"}}).directive("tooltipHtmlUnsafe",["$tooltip",function(t){return t("tooltipHtmlUnsafe","tooltip","mouseenter")}]);
angular.module("ui.bootstrap.dropdown",[]).constant("dropdownConfig",{openClass:"open"}).service("dropdownService",["$document",function(n){var e=null;this.open=function(i){e||(n.bind("click",o),n.bind("keydown",t)),e&&e!==i&&(e.isOpen=!1),e=i},this.close=function(i){e===i&&(e=null,n.unbind("click",o),n.unbind("keydown",t))};var o=function(n){var o=e.getToggleElement();n&&o&&o[0].contains(n.target)||e.$apply(function(){e.isOpen=!1})},t=function(n){27===n.which&&(e.focusToggleElement(),o())}}]).controller("DropdownController",["$scope","$attrs","$parse","dropdownConfig","dropdownService","$animate",function(n,e,o,t,i,r){var l,c=this,s=n.$new(),a=t.openClass,u=angular.noop,d=e.onToggle?o(e.onToggle):angular.noop;this.init=function(t){c.$element=t,e.isOpen&&(l=o(e.isOpen),u=l.assign,n.$watch(l,function(n){s.isOpen=!!n}))},this.toggle=function(n){return s.isOpen=arguments.length?!!n:!s.isOpen},this.isOpen=function(){return s.isOpen},s.getToggleElement=function(){return c.toggleElement},s.focusToggleElement=function(){c.toggleElement&&c.toggleElement[0].focus()},s.$watch("isOpen",function(e,o){r[e?"addClass":"removeClass"](c.$element,a),e?(s.focusToggleElement(),i.open(s)):i.close(s),u(n,e),angular.isDefined(e)&&e!==o&&d(n,{open:!!e})}),n.$on("$locationChangeSuccess",function(){s.isOpen=!1}),n.$on("$destroy",function(){s.$destroy()})}]).directive("dropdown",function(){return{restrict:"CA",controller:"DropdownController",link:function(n,e,o,t){t.init(e)}}}).directive("dropdownToggle",function(){return{restrict:"CA",require:"?^dropdown",link:function(n,e,o,t){if(t){t.toggleElement=e;var i=function(i){i.preventDefault(),e.hasClass("disabled")||o.disabled||n.$apply(function(){t.toggle()})};e.bind("click",i),e.attr({"aria-haspopup":!0,"aria-expanded":!1}),n.$watch(t.isOpen,function(n){e.attr("aria-expanded",!!n)}),n.$on("$destroy",function(){e.unbind("click",i)})}}}});
(function(){angular.module("ui.bootstrap.selected",["angular.template.modal","ui.bootstrap.modal","angular.template.tooltip","ui.bootstrap.tooltip","ui.bootstrap.dropdown"])}).call(this);
(function(){function t(t){function e(){}return e.prototype=t,new e}var e,n,r,a,i=[].join;angular.module("app.service",["ngSanitize","ga","ui.bootstrap.selected"]).factory("WindowScroller",["$window","$timeout","$rootScope"].concat(function(t,e,n){var r,a,i,c,o,s;return r=angular.element(t),a={},i=function(){return a.offsetHeight=t.document.body.offsetHeight,a.clientHeight=t.document.body.clientHeight,a.scrollTop=t.document.body.scrollTop,a},c=[],o=!1,s=function(){var t;return n.$apply(function(){var t,e,n,r,i=[];for(t=0,n=(e=c).length;n>t;++t)r=e[t],i.push(r(a));return i}),t=!1},r.on("scroll",function(){var t;return i(),t?void 0:(requestAnimationFrame(s),t=!0)}),{subscribe:function(t){return c.push(t),e(function(){return t(i())}),function(){return c.splice(c.indexOf(t),1)}}}})).service("Spy",e=function(){function t(){this.spies=[],this.current=null}t.displayName="Spy";var e=t.prototype;return e.add=function(t){return this.spies=this.spies.concat(t)},e.remove=function(t){return this.spies.splice(this.spies.indexOf(t),1)},t}()).service("State",n=function(){function t(){function t(t,e){this[t]=e[0]}var e,r,a={}.hasOwnProperty;for(e in r=n["enum"])a.call(r,e)&&t.call(this,e,r[e])}t.displayName="State";var e=t.prototype,n=t;return t["enum"]={titlebar:["title","toolbox"],labels:[!0,!1],comment:[null]},e.$cycle=function(t){var e,r;return e=n["enum"][t].indexOf(this[t]),r=(e+1)%n["enum"][t].length,console.log(e,r),this[t]=n["enum"][t][r]},e.$reset=function(t){return this[t]=n["enum"][t][0]},e.$isDefault=function(t){return this[t]===n["enum"][t][0]},t}()).service("UserPreference",r=function(){function t(t){var n;e=t.localStorage,this.canSendData()&&(n=e.userId=e.userId||""+Math.random(),ga("set","dimension1",n))}t.displayName="UserPreference";var e,n=t.prototype;return e=null,t.$inject=["$window"],n.subscribe=function(t){e.email=t},n.getEmail=function(){return e.email},n.backout=function(){e.isBackedout=!0},n.canSendData=function(){return!e.isBackedout},t}()).factory("HtmlDecoder",function(){var t;return t=angular.element("<textarea></textarea>")[0],function(e){return t.innerHTML=e,t.value}}).factory("HighlightParser",["$interpolate","CommentParser"].concat(function(e,n){var r,a,c,o,s,l,u,p,m,f;return r=/<span[^>]*>([^<]+)<\/span>((?:<sup>.+?<\/sup>)+)/gim,a=/#cmnt(\d+)/g,c="#cmnt".length,o=/<span[^>]*>/gim,s=/<\/span>/gim,l="xx-span-xx",u=new RegExp(l,"gm"),p=/\s+class="[^"]+"/gim,m=function(n){return n=t(n),n.placement="{{placement}}",n.tagName||(n.tagName="span"),n.classes=JSON.stringify(n.classes||{}),e('<{{tagName}} comment="{{id}}" comment-placement="{{placement}}" comment-append-to-body="true" ng-class=\'{{classes}}\'>{{content}}</{{tagName}}>')(n)},f=function(t,e){return null==e&&(e={}),t.replace(r,function(t,r,o){function s(){var t;switch(null!=(t=e[d])&&t.type){case n.types.REF_MISSING:case n.types.REF_CONTROVERSIAL:return"is-controversial";case n.types.NOTE:return"is-info"}}var u,p,f,h,d,g;for(u=o.match(a).map(function(t){return t.slice(c)}),p={},f=0,h=u.length;h>f;++f)d=u[f],g=s(),g&&(p[g]=!0);return m({id:i.call(u,","),content:r,tagName:l,classes:p})}).replace(o,"").replace(s,"").replace(p,"").trim().replace(u,"span")},f.GENERATE_COMMENT=m,f})).factory("ItemSplitter",function(){var t,e,n;return t=/\[\s*&#20986;&#34389;\s*(?:&#160;)*/gm,e=/]/gim,n=/<span\s*[^>]*><\/span>/gim,function(r){var a;return a=r.search(t),-1===a&&(a=r.length),{content:r.slice(0,a),ref:r.slice(a).replace(t,"").replace(e,"").replace(n,"").trim()}}}).factory("TableParser",["ItemSplitter","HighlightParser","$sanitize","CommentParser"].concat(function(t,e,n,r){function a(t){return t.replace(s,"").trim()}function i(t){return t.replace(u,"").replace(p,"").trim()}var c,o,s,l,u,p;return c=/<tr[^>]*>(.+?)<\/tr>/gim,o=/<td[^>]*>(.*?)<\/td>/gim,s=/<\/?[^>]*>/gim,l=/<li[^>]*>(.+?)<\/li>/gim,u=/<li[^>]*>/,p=/<\/li>/,function(s){var u,p,m,f,h,d,g,v,y,b,S,N,E,O,T,M,R,$,x,C,I,P,w;for(u=r(s),p=s.replace(/\n/gm,"").match(c)||[""],m=(null!=(f=p[0].match(o))?f.slice(1):void 0)||[],d=[],g=0,v=m.length;v>g;++g)y=m[g],d.push(a(y));for(h=d,p.shift(),d=[],g=0,v=p.length;v>g;++g){for(S=p[g],m=S.match(o),N=a(m[0]),m.shift(),O=[],T=0,M=m.length;M>T;++T){for(y=m[T],R=y.match(l)||[],x=[],C=0,I=R.length;I>C;++C)P=R[C],w=t(i(P)),w.content=e(n(w.content),u),w.ref=e(n(w.ref),u),x.push(w);$=x,O.push($)}E=O,d.push({title:N,positions:E})}return b=d,{positionTitle:h,perspectives:b,comments:u}}})).factory("TableData",["TableParser","CommentParser","$http","DATA_URL"].concat(function(t,e,n,r){return n.get(r).then(function(e){return t(e.data)})})).factory("CommentParser",["linky"].concat(function(t){var e,n,r,a,i,c,o,s,l,u,p,m;return e="REF_MISSING",n="REF_CONTROVERSIAL",r="NOTE",a="SECOND",i="OTHER",c=/<div[^>]*><p[^>]*><a[^>]+name="cmnt(\d+)">[^>]+<\/a>(.+?)<\/div>/gim,o=/^\[([^\]]+)\]\s*/,s=/^\+1/,l=/<span class="[^"]+">/gim,u=/<\/span>/gim,p=/\s+class="[^"]+"/gim,m=function(m){function f(){switch(y){case"&#35036;&#20805;&#35498;&#26126;":return r;case"&#38656;&#35201;&#20986;&#34389;":return e;case"&#20986;&#34389;&#29229;&#35696;":return n;default:return i}}var h,d,g,v,y,b,S,N;for(h={};d=c.exec(m);)g=d[1],v=d[2].replace(l,"").replace(u,"").replace(p,"").trim(),y=null!=(b=v.match(o))?b[1]:void 0,S=f(),N=v.replace(o,"").trim(),N.match(s)&&(S=a),N=t("<p>"+N),h[g]={type:S,content:N};return h},m.types={REF_MISSING:e,REF_CONTROVERSIAL:n,NOTE:r,SECOND:a,OTHER:i},m})).factory("linky",function(){var t,e;return t=/((ftp|https?):\/\/|(mailto:)?[A-Za-z0-9._%+-]+@)[^\s<>]*[^\s.;,(){}<>]/,e=/^mailto:/,function(n,r){function a(t){return t?o.push(t):void 0}function i(t,e){return o.push("<a "),angular.isDefined(r)&&(o.push('target="'),o.push(r),o.push('" ')),o.push('href="'),o.push(t),o.push('">'),a(e),o.push("</a>")}var c,o,s,l,u;if(!n)return n;for(c=n,o=[];s=c.match(t);)l=s[0],s[2]===s[3]&&(l="mailto:"+l),u=s.index,a(c.substr(0,u)),i(l,s[0].replace(e,"")),c=c.substring(u+s[0].length);return a(c),o.join("")}}).service("ModalManager",a=function(){function t(t){this.$modal=t}t.displayName="ModalManager";var e,n=t.prototype;return e={edit:{templateUrl:"public/templates/edit.html",controller:"ModalCtrl as Modal"},subscribe:{templateUrl:"public/templates/subscribe-modal.html",controller:"ModalCtrl as Modal",size:"sm"},info:{templateUrl:"public/templates/info.html",controller:"ModalCtrl as Modal"}},t.$inject=["$modal"],n.open=function(t){return this.$modal.open(e[t])},t}())}).call(this);
(function(){angular.module("app.controller",["app.constant","app.service","ga"]).controller("AppCtrl",["EDIT_URL","TableData","Spy","State","ModalManager"].concat(function(t,n,e,o,l){var c=this;this.EDIT_URL=t,n.then(function(t){return c.data=t}),this.State=o,this.openEditModal=function(t){t.preventDefault(),l.open("edit")}})).controller("HeaderCtrl",["Spy","State","$scope","$anchorScroll","$location","ModalManager","ga","HtmlDecoder"].concat(function(t,n,e,o,l,c,i,r){function a(){s.labelAction=n.labels?"按一下關閉":"按一下開啟"}var s=this;this.Spy=t,this.scrollTo=function(t,n){t.preventDefault(),l.hash(n),o()},e.$watch(function(){return t.current},function(){var e;n.titlebar="title",null!==t.current&&(e=r(t.spies[t.current]),i("send","pageview",{title:e}))}),this.openInfoModal=function(){c.open("info")},this.openSubscribeModal=function(){c.open("subscribe")},a(),this.toggleLabels=function(){return n.$cycle("labels"),a()}})).controller("ModalCtrl",["EDIT_URL","RULE_URL","DISCUSS_URL"].concat(function(t,n,e){this.EDIT_URL=t,this.RULE_URL=n,this.DISCUSS_URL=e})).controller("SubscriptionCtrl",["UserPreference","$scope"].concat(function(t,n){var e=this;console.log("Subscription control"),this.email=t.getEmail(),this.subscribe=function(){console.log("SUBSCRIBE",e.email),t.subscribe(e.email),n.$close&&n.$close()}})).controller("MeetingCtrl",function(){this.isDue=function(t){return new Date>new Date(t)}})}).call(this);
angular.module("app.template",[]).run(["$templateCache",function(a){a.put("public/templates/comment-popup.html",'<div ng-class="{ in: isOpen(), fade: animation() }" class="tooltip {{placement}}"><div class="tooltip-arrow"></div><div class="tooltip-inner"><div ng-repeat="comment in comments track by $index" class="text-left"><div ng-switch="comment.type"><span ng-switch-when="REF_MISSING" class="label label-warning">需要來源</span><span ng-switch-when="REF_CONTROVERSIAL" class="label label-warning">來源爭議</span><span ng-switch-when="NOTE" class="label label-info">補充說明</span></div><div ng-bind-html="comment.content"></div></div><p><a ng-click="edit($event)" href="#" ga ga-label="comment.edit"><span class="glyphicon glyphicon-plus"></span> \n新增回應</a></p></div></div>'),a.put("public/templates/edit.html",'<div class="modal-header"><h2 class="modal-title">編輯公約</h2></div><div class="modal-body"><p class="lead">《自經區比較表》希望成為討論自經區的議題共筆。集眾人之力編成的<u>精簡</u>而<u>有力</u>的論述，是比較表的核心價值。</p><p>為了讓這份表格能為大眾持續提供價值，請大家遵守<a ng-href="{{::Modal.RULE_URL}}" ga ga-label="\'edit.rules\'">編輯規則</a>，概述如下。</p><ul><li>「有力」的論述不只要講結論，還要帶到<u>原因</u>，讓讀者一眼就能看出思考脈絡。</li><li>目前完全開放匿名編輯，包含新增、修改，以及用「註解」標記爭議與補充說明。</li><li>表格管理員會定期精簡文字、標記出處問題與爭議（類似維基百科的管理模式）。</li></ul></div><div class="modal-footer"><a ng-href="{{::Modal.EDIT_URL}}" ga ga-label="\'edit.gdoc\'" class="btn btn-lg btn-primary">前往編輯表格</a><a ng-href="{{::Modal.DISCUSS_URL}}" ga ga-label="\'edit.discuss\'" class="btn btn-lg btn-link">編輯討論區</a><a ng-href="{{::Modal.RULE_URL}}" ga ga-label="\'edit.rules\'" class="btn btn-lg btn-link">編輯規則與 Q &amp; A</a></div>'),a.put("public/templates/empty.html",'目前沒有論述。<br><a ng-href="{{App.EDIT_URL}}" ng-click="App.openEditModal($event)">我來補充</a>！'),a.put("public/templates/info.html",'<div class="modal-header"><button type="button" ng-click="$close()" class="close">&times;</button><h2 class="modal-title">自經區正反意見比較表&nbsp;&nbsp;&nbsp;&nbsp;<small><a href="https://github.com/fepztw/fepztw.github.io/tree/dev"><span class="glyphicon glyphicon-link"></span>網站原始碼</a></small></h2></div><div class="modal-body"><p>立場選擇是一件困難的事情。若想要參照雙方說法，決定自己在爭議性議題（ex: 服貿、自經區）的立場，會有大量的資料要讀；有些反方的疑慮已經被政府解答，而有些政府的解答造成了更新的疑慮，人們往往會迷失在這些推陳出新的討論中，或需要花費大量的精力來記憶哪些人說了什麼話，以及哪些問題還沒有被解答。</p><p>我們是來自台大資工的團隊，用 Google Doc 作為編輯介面，完全開放大家進行編輯；希望這份表格能成為雙方討論的事實基準與目前爭議點的全民共筆。</p><p>您在這份表格的瀏覽行為會作為<a href="https://compatable.hackpad.com/cotable-Bringing-the-Experience-of-Decision-Making-in-Shopping-to-Controversial-Issues-i02ML0HiVvI">未來設計比較表介面</a>的重要量化參考。我們不會對外洩漏您的閱覽資料，若不希望您在表格上的瀏覽行為被納入資料集，請<a href="mailto:johnsonliang7+fepz@gmail.com">聯絡我們</a>。</p></div><div class="modal-footer"><div class="row"><div class="col-sm-6"><div ng-include="\'public/templates/subscribe.html\'"></div></div><div class="col-sm-6"><h4>製作協力</h4><p><a href="http://www.ntumobile.org/">台大行動人機互動實驗室</a><a href="mailto:johnsonliang7+fepz@gmail.com">（實驗聯絡人）</a></p><p><a href="http://www.cs.nccu.edu.tw/~jonesyu/cv.html">政大創新使用者介面研究室</a></p><p><a href="http://g0v.tw/"><img src="public/images/g0v-logo.png"></a></p></div></div></div>'),a.put("public/templates/subscribe-modal.html",'<div class="modal-body"><div ng-include="\'public/templates/subscribe.html\'"></div></div>'),a.put("public/templates/subscribe.html",'<form action="//ntumobile.us8.list-manage.com/subscribe/post?u=148389f54bebfebbb905777bf&amp;amp;id=16805b868e" ng-controller="SubscriptionCtrl as Subscribe" method="post" target="_blank" ng-submit="Subscribe.subscribe()"><h4>表格更新時通知我</h4><input name="EMAIL" ng-model="Subscribe.email" type="email" placeholder="請輸入 Email address..." required class="form-control"><div class="help-block">寄件頻率不會高於一週兩次。</div><div style="position: absolute; left: -5000px;"><input type="text" tabindex="-1" name="b_148389f54bebfebbb905777bf_16805b868e"></div><p><button type="submit" class="btn btn-primary btn-lg">訂閱表格</button><a href="http://us8.campaign-archive2.com/home/?u=148389f54bebfebbb905777bf&amp;id=16805b868e" class="btn btn-link">過去信件彙整</a></p><p><small>Powered by <a href="http://eepurl.com/YG4xP" title="MailChimp - email marketing made easy and fun">MailChimp</a></small></p></form>')}]);
/*
 AngularJS v1.3.0-beta.14
 (c) 2010-2014 Google, Inc. http://angularjs.org
 License: MIT
...
(function(){angular.module("app.directive",["app.service","ngAnimate","ngSanitize","ui.bootstrap.selected","ga"]).directive("vuSticky",["WindowScroller"].concat(function(n){var t;return t="is-sticky",function(e,o,c){var r,i,u;return r=o.hasClass(t),i=+c.vuSticky,u=n.subscribe(function(n){var e;return e=n.scrollTop,e>i&&r!==!0?(r=!0,o.addClass(t)):i>e&&r!==!1?(r=!1,o.removeClass(t)):void 0}),e.$on("$destroy",u)}})).directive("vuSpy",["$window","Spy"].concat(function(n,t){return function(e,o,c){function r(){m=o[0].getBoundingClientRect(),p=n.innerHeight}function i(){e.$apply(function(){return t.current=t.spies.indexOf(l)}),v=!1}function u(){r(),!v&&m.top<=0&&m.bottom>0&&(n.requestAnimationFrame(i),v=!0)}function a(){angular.element(n).off("scroll",u)}var l,m,p,v;return l=e.$eval(c.vuSpy),t.add(l),m=p=null,v=!1,u(),angular.element(n).on("scroll",u),e.$on("$destory",function(){return t.remove(l),a()})}})).directive("noAnimate",["$animate"].concat(function(n){return function(t,e){return n.enabled(!1,e)}})).directive("vuCompile",["$compile"].concat(function(n){return{restrict:"EA",link:function(t,e,o){var c,r;return c=t.$eval(o.tmpl),r=n("<div>"+c+"</div>")(t),e.html("").append(r)}}})).config(["$tooltipProvider"].concat(function(n){n.setTriggers({"$comment-on":"$comment-off"})})).directive("commentPopup",["TableData","ModalManager","State"].concat(function(n,t,e){return{restrict:"EA",replace:!0,scope:{content:"@",placement:"@",animation:"&",isOpen:"&"},templateUrl:"public/templates/comment-popup.html",link:function(o,c){return n.then(function(n){var t;return o.comments=function(){var e,c,r,i=[];for(e=0,r=(c=o.content.split(",")).length;r>e;++e)t=c[e],i.push(n.comments[t]);return i}()}),o.edit=function(n){return n.preventDefault(),e.$reset("comment"),t.open("edit")},c.on("click",function(n){return n.stopPropagation()})}}})).directive("comment",["$tooltip","State","$timeout","$document","$rootScope","$window"].concat(function(n,t,e,o,c,r){var i,u,a;return i=function(){return t.$isDefault("comment")?void 0:c.$apply(function(){return t.$reset("comment")})},o.on("click",i),o.on("keyup",function(n){return 27===n.which?i():void 0}),u=n("comment","comment","$comment-on"),a=u.compile,u.compile=function(){var n;return n=a.apply(this,arguments),function(o,c,i){var u,a;o.placement="top",n.apply(this,arguments),u=i.comment.split(",")[0],a=function(n){return n.stopPropagation(),o.placement=c[0].getBoundingClientRect().top<r.innerHeight/2?"bottom":"top",o.$apply(function(){return t.comment=u})},c.on("mouseenter",a),c.on("click",a),o.$watch(function(){return t.comment},function(n){e(n===u?function(){return c.triggerHandler("$comment-on")}:function(){return c.triggerHandler("$comment-off")})})}},u})).directive("vuTrack",["ga","HtmlDecoder","DIMENSIONS","$timeout","$window"].concat(function(n,t,e,o,c){return function(r,i,u){var a,l,m,p,v,s,f,d;a=r.$eval(u.vuTrack),null!=a.perspective&&(a.perspective=t(a.perspective)),null!=a.content&&(a.content=t(a.content)),m={hitType:"event",eventCategory:a.category||"button",eventLabel:a.label,eventValue:1},m[e.PERSPECTIVE+""]=a.perspective,m[e.POSITION+""]=a.position,l=m,null!=a.content&&(l.eventCategory="item",l.eventLabel=a.content),p=angular.extend({},l,{eventAction:"click"}),v=angular.extend({},l,{eventAction:"hover"}),s=angular.extend({},l,{eventAction:"copy"}),i.on("click",function(){return n("send",p)}),f=null,d=null,i.on("mouseleave",function(){var t;return f&&o.cancel(f),t=Date.now()-d,n("send","timing",l.eventCategory,"hover",t,l.eventLabel),f=null,d=null}),i.on("mouseenter",function(){return d=Date.now(),f=o(function(){n("send",v),f=null},500)}),i.on("copy",function(){s[e.ITEM_CONTENT]=c.getSelection()+"",n("send",s)})}}))}).call(this);
(function(){angular.module("app",["app.controller","app.template","app.directive"]).run(["UserPreference"].concat(function(){}))}).call(this);
