...
(function(){angular.module("app.constant",[]).constant("EDIT_URL","https://docs.google.com/document/d/189K9aM7m9wrxoj63De3zoBrK0LDYDF76_BTROXWPR4M/edit")}).call(this);
(function(){var t,e;angular.module("app.service",[]).factory("WindowScroller",["$window","$timeout","$rootScope"].concat(function(t,e,n){var i,o,r,u,l,s;return i=angular.element(t),o={},r=function(){return o.offsetHeight=t.document.body.offsetHeight,o.clientHeight=t.document.body.clientHeight,o.scrollTop=t.document.body.scrollTop,o},u=[],l=!1,s=function(){var t;return n.$apply(function(){var t,e,n,i,r=[];for(t=0,n=(e=u).length;n>t;++t)i=e[t],r.push(i(o));return r}),t=!1},i.on("scroll",function(){var t;return r(),t?void 0:(requestAnimationFrame(s),t=!0)}),{subscribe:function(t){return u.push(t),e(function(){return t(r())}),function(){return u.splice(u.indexOf(t),1)}}}})).service("Spy",t=function(){function t(){this.spies=[],this.current=null}t.displayName="Spy";var e=t.prototype;return e.add=function(t){return this.spies=this.spies.concat(t)},e.remove=function(t){return this.spies.splice(this.spies.indexOf(t),1)},t}()).service("State",e=function(){function t(){function t(t,e){this[t]=e[0]}var e,i,o={}.hasOwnProperty;for(e in i=n["enum"])o.call(i,e)&&t.call(this,e,i[e])}t.displayName="State";var e=t.prototype,n=t;return t["enum"]={titlebar:["title","toolbox"]},e.$cycle=function(t){var e,i;return e=n["enum"][t].indexOf(this[t]),i=(e+1)%n["enum"][t].length,console.log(e,i),this[t]=n["enum"][t][i]},t}()).factory("MockData",["$q","$timeout"].concat(function(t,e){var n;return n=t.defer(),e(function(){var t;return t={positionTitle:["正方／支持自經區","反方／自經區的疑慮"],perspectives:[{title:["政策","條例"],fullTitle:"政策與條例",positions:[["2012年政府民調顯示，超過 6 成民意支持台灣加入區域經濟整合，包含 TPP。","美國 CSIS 民調 100% 支持台灣參加 RCEP 與 TPP 區域經濟整合。","產業與企業開放，主管機關是經濟部，什麼階段開放了什麼，都會公布。如果覺得作不好，就監督經濟部。","示範區面對的「外國」，依國內法制，不包含中國。示範區對中國大陸另有限制。","去年的法令修改與鬆綁，必須要自經區條例通過後才會生效，並且受立法院監看；若自經區沒過，那法規鬆綁就不會生效。","空白授權的法案，細節訂完之後，需要送立法院備查，立法院也可以退案。"],[]]},{title:["農業","環境"],fullTitle:"農業與環境",positions:[[],[]]},{title:["健康","醫療"],fullTitle:"健康與醫療",positions:[["簡化行政程序，特定職業以特別法立法，吸引外籍專業人士於示範區工作。","每年預計吸引 93 個外籍專業人士。"],["為自經區鬆綁的外國人從事就業服務法審核標準之勞工預核制違背其母法就業服務法§47優先雇用本勞之精神。"]]},{title:["租稅","土地"],fullTitle:"租稅與土地",positions:[["公有不動產讓售不受民意監督，但必須依照市價售出，符合公產權益。","規定行政院會核定新示範區的設立。","新示範區經費等需經過地方議會同意，故新設示範區會受民意機關監督。","國外對示範區內的實質投資免稅。","外籍專業人士，三年內所得稅半價。","內銷貨物佔年度銷售總額 10% 內可免稅，超過者仍要交稅，鼓勵外銷。","租稅淨效益為正，比「直接補助」對國家之衝擊小。"],["公有不動產（如政府土地）可以逕行讓售，不受民意機關同意與行政院核准，公有地可不經民意監督私相讓售。","過去減稅讓電子業受益，但國外直接投資不增反減，稅賦天平歪斜。"]]},{title:["物流","金融"],fullTitle:"物流與金融",positions:[["智慧物流之貨物進出示範區需用電子系統向海關通關，區內廠商必須建立電子帳冊受海關稽核。"],[]]}]},n.resolve(t)}),n.promise}))}).call(this);
...
(function(){angular.module("app.controller",["app.constant","app.service","ui.bootstrap.selected"]).controller("AppCtrl",["EDIT_URL","MockData","Spy","State","$modal"].concat(function(t,e,n,o,l){var a=this;this.EDIT_URL=t,e.then(function(t){return a.data=t}),this.State=o,this.openEditModal=function(t){t.preventDefault(),l.open({templateUrl:"public/templates/edit.html"})}})).controller("HeaderCtrl",["Spy","State","$scope","$anchorScroll","$location","$modal"].concat(function(t,e,n,o,l,a){this.Spy=t,this.scrollTo=function(t,e){t.preventDefault(),l.hash(e),o()},n.$watch(function(){return t.current},function(){return e.titlebar="title"}),this.openInfoModal=function(){a.open({templateUrl:"public/templates/info.html"})},this.openSubscribeModal=function(){a.open({templateUrl:"public/templates/subscribe-modal.html",size:"sm"})}}))}).call(this);
angular.module("app.template",[]).run(["$templateCache",function(a){a.put("public/templates/edit.html",'<div class="modal-header"><h2 class="modal-title">編輯公約</h2></div><div class="modal-body"><p class="lead">歡迎大家編輯，品質 blahblah 所以請大家遵守<a href="https://compatable.hackpad.com/GinYVZGLviX">編輯規則</a>，概述如下。</p><ul><li>目前是匿名，是情況更改（實驗說明）</li><li>我們會刪改字，標上標籤。</li><li>大家可以在 google doc</li></ul></div><div class="modal-footer"><a href="{{::App.EDIT_URL}}" class="btn btn-lg btn-primary">前往編輯表格</a><a href="" class="btn btn-lg btn-link">編輯規則與 Q &amp; A</a></div>'),a.put("public/templates/empty.html",'目前沒有論述。<br><a ng-href="{{App.EDIT_URL}}" ng-click="App.openEditModal($event)">我來補充</a>！'),a.put("public/templates/info.html",'<div class="modal-header"><button type="button" ng-click="$close()" class="close">&times;</button><h2 class="modal-title">自經區正反意見比較表&nbsp;&nbsp;&nbsp;&nbsp;<small><a href="https://github.com/fepztw/fepztw.github.io"><span class="glyphicon glyphicon-link"></span>網站原始碼</a></small></h2></div><div class="modal-body"><p>立場選擇是一件困難的事情。若想要參照雙方說法，決定自己在爭議性議題（ex: 服貿、自經區）的立場，會有大量的資料要讀；有些反方的疑慮已經被政府解答，而有些政府的解答造成了更新的疑慮，人們往往會迷失在這些推陳出新的討論中，或需要花費大量的精力來記憶哪些人說了什麼話，以及哪些問題還沒有被解答。</p><p>我們是來自台大資工的團隊，用 Google Doc 作為編輯介面，完全開放大家進行編輯；希望這份表格能成為雙方討論的事實基準與目前爭議點的全民共筆。</p><p>您在這份表格的瀏覽行為會作為<a href="https://compatable.hackpad.com/cotable-Bringing-the-Experience-of-Decision-Making-in-Shopping-to-Controversial-Issues-i02ML0HiVvI">未來設計比較表介面</a>的重要量化參考。我們不會對外洩漏您的閱覽資料，若不希望您的瀏覽行為被納入資料集，請<a href="#">按這裡退出資料收集</a>。</p></div><div class="modal-footer"><div class="row"><div class="col-sm-6"><div ng-include="\'public/templates/subscribe.html\'"></div></div><div class="col-sm-6"><h4>製作協力</h4><p><a http://www.ntumobile.org/>台大行動人機互動實驗室</a><a href="#">（研究說明）</a></p><p><a http://www.cs.nccu.edu.tw/~jonesyu/cv.html>政大創新使用者介面研究室</a></p><p><a href="http://g0v.tw/"><img src="public/images/g0v-logo.png"></a></p></div></div></div>'),a.put("public/templates/subscribe-modal.html",'<div class="modal-body"><div ng-include="\'public/templates/subscribe.html\'"></div></div>'),a.put("public/templates/subscribe.html",'<form action="//ntumobile.us8.list-manage.com/subscribe/post?u=148389f54bebfebbb905777bf&amp;amp;id=16805b868e" method="post" target="_blank" name="App.subscribeForm" novalidate ng-submit="$close()"><h4>表格更新時通知我</h4><input name="EMAIL" ng-modal="App.email" type="email" placeholder="請輸入 Email address..." class="form-control"><div class="help-block">寄件頻率不會高於一週兩次。</div><div style="position: absolute; left: -5000px;"><input type="text" tabindex="-1" name="b_148389f54bebfebbb905777bf_16805b868e"></div><p><button type="submit" class="btn btn-primary btn-lg">訂閱表格</button><a href="http://us8.campaign-archive2.com/home/?u=148389f54bebfebbb905777bf&amp;id=16805b868e" class="btn btn-link">過去信件彙整</a></p><p><small>Powered by <a href="http://eepurl.com/YG4xP" title="MailChimp - email marketing made easy and fun">MailChimp</a></small></p></form>')}]);
/*
 AngularJS v1.3.0-beta.14
 (c) 2010-2014 Google, Inc. http://angularjs.org
 License: MIT
...
(function(){angular.module("app.directive",["app.service","ngAnimate","ui.bootstrap.selected"]).directive("vuSticky",["WindowScroller"].concat(function(n){var e;return e="is-sticky",function(t,r,i){var o,c,u;return o=r.hasClass(e),c=+i.vuSticky,u=n.subscribe(function(n){var t;return t=n.scrollTop,t>c&&o!==!0?(o=!0,r.addClass(e)):c>t&&o!==!1?(o=!1,r.removeClass(e)):void 0}),t.$on("$destroy",u)}})).directive("vuSpy",["$window","Spy"].concat(function(n,e){return function(t,r,i){function o(){s=r[0].getBoundingClientRect(),d=n.innerHeight}function c(){t.$apply(function(){return e.current=e.spies.indexOf(l)}),f=!1}function u(){o(),!f&&s.top<=0&&s.bottom>0&&(n.requestAnimationFrame(c),f=!0)}function a(){angular.element(n).off("scroll",u)}var l,s,d,f;return l=t.$eval(i.vuSpy),e.add(l),s=d=null,f=!1,u(),angular.element(n).on("scroll",u),t.$on("$destory",function(){return e.remove(l),a()})}})).directive("noAnimate",["$animate"].concat(function(n){return function(e,t){return n.enabled(!1,t)}}))}).call(this);
