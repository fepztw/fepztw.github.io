...
(function(){angular.module("app.controller",["app.constant"]).controller("AppCtrl",["EDIT_URL"].concat(function(t){this.msg="It works!",this.EDIT_URL=t}))}).call(this);
angular.module("app.template",[]).run(["$templateCache",function(e){e.put("public/templates/empty.html",'目前這方沒有論述。<br><a ng-href="{{App.EDIT_URL}}">我來補充</a>！')}]);
(function(){angular.module("app",["app.controller","app.template","angular.template"])}).call(this);
