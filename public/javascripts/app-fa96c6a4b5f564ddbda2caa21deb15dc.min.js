...
angular.module("app.template",[]).run(["$templateCache",function(t){t.put("public/templates/comment-popup.html",'<div ng-class="{ in: isOpen(), fade: animation() }" class="tooltip {{placement}}"><div class="tooltip-arrow"></div><div class="tooltip-inner"><div ng-repeat="comment in comments track by $index">{{comment.type}}<div ng-bind-html="comment.content"></div></div></div></div>'),t.put("public/templates/edit.html",'<div class="modal-header"><h2 class="modal-title">編輯公約</h2></div><div class="modal-body"><p class="lead">歡迎大家編輯，品質 blahblah 這 modal 內容還沒寫好呀，所以請大家遵守<a ng-href="{{::Modal.RULE_URL}}">編輯規則</a>，概述如下。</p><ul><li>目前是匿名，是情況更改（實驗說明）</li><li>我們會刪改字，標上標籤。</li><li>大家可以在 google doc</li></ul></div><div class="modal-footer"><a ng-href="{{::Modal.EDIT_URL}}" class="btn btn-lg btn-primary">前往編輯表格</a><a ng-href="{{::Modal.RULE_URL}}" class="btn btn-lg btn-link">編輯規則與 Q &amp; A</a></div>'),t.put("public/templates/empty.html",'目前沒有論述。<br><a ng-href="{{App.EDIT_URL}}" ng-click="App.openEditModal($event)">我來補充</a>！'),t.put("public/templates/info.html",'<div class="modal-header"><button type="button" ng-click="$close()" class="close">&times;</button><h2 class="modal-title">自經區正反意見比較表&nbsp;&nbsp;&nbsp;&nbsp;<small><a href="https://github.com/fepztw/fepztw.github.io"><span class="glyphicon glyphicon-link"></span>網站原始碼</a></small></h2></div><div class="modal-body"><p>立場選擇是一件困難的事情。若想要參照雙方說法，決定自己在爭議性議題（ex: 服貿、自經區）的立場，會有大量的資料要讀；有些反方的疑慮已經被政府解答，而有些政府的解答造成了更新的疑慮，人們往往會迷失在這些推陳出新的討論中，或需要花費大量的精力來記憶哪些人說了什麼話，以及哪些問題還沒有被解答。</p><p>我們是來自台大資工的團隊，用 Google Doc 作為編輯介面，完全開放大家進行編輯；希望這份表格能成為雙方討論的事實基準與目前爭議點的全民共筆。</p><p>您在這份表格的瀏覽行為會作為<a href="https://compatable.hackpad.com/cotable-Bringing-the-Experience-of-Decision-Making-in-Shopping-to-Controversial-Issues-i02ML0HiVvI">未來設計比較表介面</a>的重要量化參考。我們不會對外洩漏您的閱覽資料，若不希望您的瀏覽行為被納入資料集，請<a href="#">按這裡退出資料收集</a>。</p></div><div class="modal-footer"><div class="row"><div class="col-sm-6"><div ng-include="\'public/templates/subscribe.html\'"></div></div><div class="col-sm-6"><h4>製作協力</h4><p><a http://www.ntumobile.org/>台大行動人機互動實驗室</a><a href="#">（研究說明）</a></p><p><a http://www.cs.nccu.edu.tw/~jonesyu/cv.html>政大創新使用者介面研究室</a></p><p><a href="http://g0v.tw/"><img src="public/images/g0v-logo.png"></a></p></div></div></div>'),t.put("public/templates/subscribe-modal.html",'<div class="modal-body"><div ng-include="\'public/templates/subscribe.html\'"></div></div>'),t.put("public/templates/subscribe.html",'<form action="//ntumobile.us8.list-manage.com/subscribe/post?u=148389f54bebfebbb905777bf&amp;amp;id=16805b868e" ng-controller="SubscriptionCtrl as Subscribe" method="post" target="_blank" ng-submit="Subscribe.subscribe()"><h4>表格更新時通知我</h4><input name="EMAIL" ng-model="Subscribe.email" type="email" placeholder="請輸入 Email address..." required class="form-control"><div class="help-block">寄件頻率不會高於一週兩次。</div><div style="position: absolute; left: -5000px;"><input type="text" tabindex="-1" name="b_148389f54bebfebbb905777bf_16805b868e"></div><p><button type="submit" class="btn btn-primary btn-lg">訂閱表格</button><a href="http://us8.campaign-archive2.com/home/?u=148389f54bebfebbb905777bf&amp;id=16805b868e" class="btn btn-link">過去信件彙整</a></p><p><small>Powered by <a href="http://eepurl.com/YG4xP" title="MailChimp - email marketing made easy and fun">MailChimp</a></small></p></form>')}]);
/*
 AngularJS v1.3.0-beta.14
 (c) 2010-2014 Google, Inc. http://angularjs.org
 License: MIT
